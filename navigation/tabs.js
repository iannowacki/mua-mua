...
const Tabs = () => {
    return(
        <Tab.Navigator inactiveColor='#FFFFFF'>
            <Tab.Screen name="Calendar" component={CalendarViewScreenNavigator} options={{headerShown: false, tabBarLabel: 'Calendar', tabBarIcon: ({ color }) => (
          ...
          tabBarIcon: ({ color }) => (
            ...
            <Tab.Screen name="View Booking" component={SearchScreenNavigator} options={{headerShown: false, tabBarLabel: 'View Bookings',
          tabBarIcon: ({ color }) => (
